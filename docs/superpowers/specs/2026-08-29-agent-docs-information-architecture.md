...
| `readers/chats-whatsapp.md` | WhatsApp-style chat export inputs, evidence, citations | `skill/scripts/chat.py`; `tests/test_chat_reader.py` |
| `connectors.md` | How harness sources (MCP, observed tabs, adapters) reach the reading core | MCP no-go spike; browser-bridge contract; `docs/harness-support.md` |
| `harness-kit.md` | Copy-and-adapt evidence-riding skill templates | `harness/skills/`; harness-support docs |
...
| `capture-adapters/ig-follow-audit.md` | Dev-only read-only follow-relationship audit | `scripts/ig_follow_audit_helper.py`; capture adapter contract |
