...
| Public Substack/RSS | Bounded capture, verified notes, selected public article and enclosure reads (#109–#111), project skill, real podcast QA and [one public access-wall skip](qa/2026-09-10-rss-access-wall.md) | Broader provider behavior and independent skill/harness acceptance: [#57](https://github.com/RikepilB/void-scape/issues/57); one publisher case does not establish general paywall detection |
